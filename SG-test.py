...
class PyGCNPTest(unittest.TestCase):
    ...
    #                 pyl = PyLouvain.from_file("C:\\Users\\xqjwo\\Desktop\\dataset\\"+y)
    #             c = pyl.apply_method(z)
    #             f = open("C:\\Users\\xqjwo\\Desktop\\dataset\\experiment_data\\"+name+"3.txt", "a+")
    #             L = name+' '+y+'参数'+str(z)+' '+str(int(c))+' '+str(int(time.perf_counter() - t0))
    #             f.write(L+'\n')
    #             f.close()
    #             print(L) 
    ...
    #             else:
    #                 pyl = PyLouvain.from_file("C:\\Users\\xqjwo\\Desktop\\dataset\\"+y)
    #             c = pyl.apply_method(Z[i])
    #             f = open("C:\\Users\\xqjwo\\Desktop\\dataset\\experiment_data\\"+name+"4."+str(i)+".txt", "a+")
    #             L = name+' '+y+'参数'+str(Z[i])+' '+str(int(c))+' '+str(int(time.perf_counter() - t0))
    #             f.write(L+'\n')
    #             f.close()
    #             print(L)
